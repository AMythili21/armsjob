...
from .views import OverseasRecruitmentListCreateView,OverseasRecruitmentDeleteView,OverseasRecruitmentDetailView,OverseasRecruitmentUpdateView,OverseasRecruitmentNameListView,OverseasRecruitmentRemarksCreateView
