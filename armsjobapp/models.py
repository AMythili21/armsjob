...
class OverseasRecruitment(models.Model):
    ...
    categories_you_can_provide = models.TextField()
    nationality_of_workers = models.CharField(max_length=255)
    mobilization_time = models.CharField(max_length=255)
    uae_deployment_experience = models.BooleanField(default=False)
    relevant_docs = models.FileField(upload_to='recruitment_docs/', null=True, blank=True)
...
class ClientEnquiry(models.Model):
    ...
    # Project Information
    nature_of_work = models.CharField(max_length=255)  # e.g., Open space / Closed space
    project_location = models.CharField(max_length=255)  # e.g., Emirates
    project_duration = models.CharField(max_length=255)  # e.g., 0-1 months, 2-3 months, etc.
    categories_required = models.TextField()
    quantity_required = models.TextField()
    ...
    query_type = models.CharField(max_length=255)  # e.g., Manpower Supply / Recruitment / etc.
    status = models.BooleanField(default=True)  # True = Active, False = Inactive
