...
class Candidate(models.Model):
    ...
    upload_cv = models.FileField(upload_to='candidates/cv/', validators=[validate_file_size],null=True,blank=True)
    photo_upload = models.ImageField(upload_to='candidates/photos/', null=True, blank=True, validators=[validate_file_size],null=True,blank=True)
    relevant_docs1 = models.FileField(upload_to='candidates/docs/', validators=[validate_file_size],null=True,blank=True)
    relevant_docs2 = models.FileField(upload_to='candidates/docs/', null=True, blank=True, validators=[validate_file_size],null=True,blank=True)
    relevant_docs3 = models.FileField(upload_to='candidates/docs/', null=True, blank=True, validators=[validate_file_size], null=True,blank=True)
